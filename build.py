...
for in_filename in to_compile:
    ...
    compile_error = os.system("clang -c -std=c99 -Wall -Wextra -Werror %s -o %s -g -include types.h -DENABLE_SLOW_DEBUG_CHECKS -DVK_USE_PLATFORM_XCB_KHR -Wno-unused-function" % (in_filename, out_filename))
