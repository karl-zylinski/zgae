...
for in_filename in to_compile:
    ...
    compile_error = os.system("clang -c -std=gnu11 -Wall -Wextra -Werror %s -o %s -g -include global_include.h -DENABLE_SLOW_DEBUG_CHECKS -DVK_USE_PLATFORM_XCB_KHR -Wno-unused-function" % (in_filename, out_filename))
